            ...
            render={({ field }) => {
                return (
                    <Autocomplete
                        ...
                        options={[...options, {...loadMoreOption, [optionLabel as any]: 'load more...'}]}
                        ...
                        renderOption={(props, option: any, { selected }) => (
                            <li {...props}>
                                ...
                                {isLoadMoreOption(option) ? <p style={moreOptionStyles}>{getOptionLabel(option)}</p> : getOptionLabel(option)}
                            </li>
                        )}
                        renderInput={(params) => (
                            <TextField
